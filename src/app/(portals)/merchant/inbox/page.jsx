        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-4 md:p-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-slate-500 mt-1">Privately resolve complaints and flip your Gader Index.</p>
                </div>
                        ...
                        {selectedChat ? (
                            <>
                                ...
                                <div className="bg-amber-50 dark:bg-amber-900/20 border-b border-amber-200 dark:border-amber-800 p-3 flex items-start gap-3">
                                    ...
                                    <p className="text-sm text-amber-800 dark:text-amber-500">
                                        <strong>Double-Blind Chat:</strong> You are speaking to an anonymous Tagdeer VIP. Their identity is protected to ensure honest feedback. Fix the issue to have this complaint removed from your public Gader Index!
                                    </p>
                                </div>
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-slate-50/50 dark:bg-slate-900/50">
                                ...
                                <p className="text-slate-500 max-w-md">
                                    You have no selected complaints. Select a pending resolution from the sidebar to chat with the customer and protect your Gader Index.
                                </p>
                            </div>
                        )}
                    </Card>
